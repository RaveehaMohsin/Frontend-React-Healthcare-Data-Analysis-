    ...
    },
    {
      ...
      render: (_, record) => (
        <Dropdown
          overlay={
            <Menu>
        <Menu.Item>Choose</Menu.Item>
        {/* <Menu.Item key="edit" onClick={() => handleEditClick(record)}>Choose</Menu.Item>  
        HERE WHEN USER WILL SELECT A DEPARTMENT THEN TABLE OF DOCTORS WILL BE SHOWN BELOW (Only that doctors of that department which the user has choose)*/}
        </Menu>         
          }
        >
