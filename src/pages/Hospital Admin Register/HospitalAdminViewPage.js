...
import OfficeForm from '../../components/ui/Hospital Admin Office Form/hospitaladminofficeform'
...
export default function Card() {
  ...
  const handleButtonClick = (buttonName) => {
    ...
    else if (buttonName === 'Office Details') {
        setShowChangePasswordForm(false);
        setShowPersonalForm(false);
        setShowOfficeForm(true);
        setPositionStyle({ paddingLeft: '20px', paddingRight: '20px', paddingTop: '20px', marginRight:'1px',position: 'absolute' });
      }
     else
     {
      setShowPersonalForm(false);
  ...
  return (
    <div style={{ backgroundColor: '#f0f0f0', minHeight: '175vh' }} >
      ...
      <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mt-10">
        ...
        <div className="flex flex-col items-center pb-10">
          ...
          <div className="flex flex-col mt-4 md:mt-6">
            ...
            <button className="custom-button" onClick={() => handleButtonClick('Office Details')}>
              <FaBuilding className="button-icon" /> Office Details
            </button>
      ...
      <div >
      {showOfficeForm && <div style={positionStyle } className="absolute z-10"><OfficeForm /> </div>}
      </div>
