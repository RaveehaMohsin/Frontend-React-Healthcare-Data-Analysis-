...
import { FaUser , FaGraduationCap, FaUserInjured, FaChartArea,  FaCalendarAlt} from 'react-icons/fa';
...
export default function Card() {
  ...
  return (
    <div style={{ backgroundColor: '#f0f0f0', minHeight: '230vh' }} >
      ...
      <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mt-10">
        ...
        <div className="flex flex-col items-center pb-10">
          ...
          <button className="custom-button" onClick={() => handleButtonClick('Analytical View')}>
            ...
            <button className="custom-button" onClick={() => handleButtonClick('Patients')}>
              <FaUserInjured  className="button-icon" />Patients
            </button>
      ...
      {/* <div>
      {showPatients && <div style={positionStyle } className="absolute z-10"><PersonalRecordForm /> </div>}
      </div>  */}
      ...
      {/* <div>
      {showAppointment && <div style={positionStyle } className="absolute z-10"><PersonalRecordForm /> </div>}
      </div> */}
